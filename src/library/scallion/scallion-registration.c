...
void scallion_register_globals(PluginFunctionTable* scallionFuncs, Scallion* scallionData) {
	scallionData->shadowlibFuncs->registerPlugin(scallionFuncs, 431,
		...
		(gsize) 0x71, (gpointer) &buf5,
		(gsize) 0x60, (gpointer) &buf4,
		(gsize) 0x71, (gpointer) &buf7,
		(gsize) 0x71, (gpointer) &buf6,
		(gsize) 0x40, (gpointer) &buf9,
		...
		(gsize) 0x20, (gpointer) &buf11,
		(gsize) 0x20, (gpointer) &buf10,
